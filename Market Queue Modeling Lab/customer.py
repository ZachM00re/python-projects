...
class Customer(object):
    ...
    def generateCustomer(cls, probabilityOfNewArrival,
        ...
        if random.random() <= probabilityOfNewArrival:
            ...
            # Assigns service time randomly selected around given average
            
            randServTime = random.randint(1, 2 * averageTimePerCustomer + 1)
            
            return Customer(arrivalTime, randServTime)
        else:
            return None
